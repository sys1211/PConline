...
public class Fragment__pingban extends Fragment{
    private ListView pingbanlist;
    private ArrayList<Channel> datelist;
    private RefreshLayout found_refreshLayout;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment__pingban,null);
        pingbanlist = (ListView) view.findViewById(R.id.pingbanList);
        datelist=new ArrayList<>();
        found_refreshLayout= (RefreshLayout) view.findViewById(R.id.pb_refreshlayout);
        initwebview();
    ...
    private void initVolley() {
        ...
        StringRequest stringRequest = new StringRequest("http://mrobot.pconline.com.cn/v2/cms/channels/400?pageNo=", new Response.Listener<String>() {
            @Override
        ...
        pingbanlist.setAdapter(new RJListAdapter(getContext(),datelist));
