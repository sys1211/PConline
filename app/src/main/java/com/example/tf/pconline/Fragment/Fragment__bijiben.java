...
public class Fragment__bijiben extends Fragment{
    private ListView bijibenList;
    private ArrayList<Channel> datelist;
    private RefreshLayout found_refreshLayout;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment__bijiben,null);
        bijibenList = (ListView) view.findViewById(R.id.bijibenList);
        datelist=new ArrayList<>();
        found_refreshLayout= (RefreshLayout) view.findViewById(R.id.bjb_refreshlayout);
        initwebview();
    ...
    private void initVolley() {
        ...
        StringRequest stringRequest = new StringRequest("http://mrobot.pconline.com.cn/v2/cms/channels/300?pageNo=", new Response.Listener<String>() {
            @Override
        ...
        bijibenList.setAdapter(new RJListAdapter(getContext(),datelist));
